            ...
            appBar: AppBar(
              ...
              actions: [
                IconButton(
                  ...
                  onPressed: () => context.read<AdminBloc>().add(const LoadAdminData()),
                ),
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            if (!hasData)
              const Padding(
                ...
                child: Row(children: [
                  ...
                  SizedBox(width: 6),
                  Text('Could not load statistics', style: TextStyle(color: Colors.orange, fontSize: 13)),
                ]),
              ),
            const SizedBox(height: 8),
            GridView.count(
              ...
              children: [
                AdminStatsCard(title: 'Total Users', value: '${stats['total_users'] ?? 0}', icon: Icons.people, color: Colors.blue),
                AdminStatsCard(title: 'Pending Approval', value: '${stats['pending_users'] ?? 0}', icon: Icons.pending, color: Colors.orange),
                AdminStatsCard(title: 'Companies', value: '${stats['total_companies'] ?? 0}', icon: Icons.business, color: Colors.purple),
                AdminStatsCard(title: 'Items', value: '${stats['total_items'] ?? 0}', icon: Icons.inventory_2, color: Colors.teal),
                AdminStatsCard(title: 'Labels', value: '${stats['total_labels'] ?? 0}', icon: Icons.label, color: Colors.indigo),
                AdminStatsCard(title: 'Pending Invitations', value: '${stats['pending_invitations'] ?? 0}', icon: Icons.mail, color: Colors.amber),
              ],
            ),
            ...
            const SizedBox(height: 8),
            Row(children: [
              _buildMiniStat('New Users', '${stats['users_today'] ?? 0}', Icons.person_add, colorScheme.primary),
              const SizedBox(width: 16),
              _buildMiniStat('New Companies', '${stats['companies_today'] ?? 0}', Icons.add_business, colorScheme.secondary),
            ]),
          ],
        ),
      ),
