...
class InventoryItem extends HiveObject {
  ...
  InventoryItem({
    this.name = '', this.code = '', this.barcode = '', this.color = '',
    this.material = '', this.size = '', this.productionDate, this.expireDate,
    this.note = '', DateTime? modified, this.quantity = 0,
    Map<String, String>? customFields, this.label = '', DateTime? createdAt,
  ...
  Map<String, String> get userCustomFields {
    ...
    fields.remove('_created_by'); fields.remove('_created_by_name');
    fields.remove('_updated_by'); fields.remove('_updated_by_name');
  ...
  String get formattedCreatedAt =>
      '${createdAt.year}-${_pad(createdAt.month)}-${_pad(createdAt.day)} ${_pad(createdAt.hour)}:${_pad(createdAt.minute)}';

  String get formattedModifiedAt =>
      '${modified.year}-${_pad(modified.month)}-${_pad(modified.day)} ${_pad(modified.hour)}:${_pad(modified.minute)}';
