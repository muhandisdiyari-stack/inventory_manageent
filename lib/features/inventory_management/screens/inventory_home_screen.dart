...
class _InventoryHomeScreenState extends State<InventoryHomeScreen> {
  ...
  void _adjustQuantity(InventoryItem item, int delta) {
    if (!_canUpdate) {
      SnackBarUtils.show(context,
          message: 'You do not have permission to update quantities',
          isError: true);
      return;
    }
    final newQuantity =
    ...
    return BlocBuilder<InventoryBloc, InventoryState>(
      builder: (context, state) {
                      ...
                      onPressed: () {
                        if (state.inventoryId != null) {
                          context.read<InventoryBloc>().add(
                              InitializeInventory(state.inventoryId!));
                        }
                      },
        ...
        return Scaffold(
          key: _scaffoldKey,
          appBar: AppBar(
            title: Text(state.inventoryName ?? 'Inventory',
                  ...
                  Expanded(
                    child: Text(
                      ...
                      style: TextStyle(
                          ...
                          fontSize: 15,
                          color: state.selectedLabel != null
                ...
                Padding(
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      hintText:
                          'Search items in ${state.selectedLabel}...',
                      prefixIcon:
                          const Icon(Icons.search, size: 18),
                      suffixIcon: _itemSearchController
                              .text.isNotEmpty
                          ? IconButton(
  ...
  Widget _buildLabelDrawer(
      InventoryState state, ColorScheme colorScheme) {
    return Drawer(
      child: SafeArea(
        child: Column(
          children: [
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text('${state.labels.length} labels',
                      style: TextStyle(
                          fontSize: 12,
                  ...
                  ? Center(
                      child: Column(
                          ...
                          children: [
                            ...
                            const SizedBox(height: 4),
                            Text(
                                'Create a label to start adding items',
                                style: TextStyle(
  ...
  void _bulkImport() {
    ...
    if (!_canCreate) {
      SnackBarUtils.show(context,
          message: 'You do not have permission to import items',
          isError: true);
      return;
    }
    Navigator.push(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
                'Open the drawer to choose a label\nor create a new one',
