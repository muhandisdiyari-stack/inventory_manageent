      ...
      return Center(
        child: Column(
          ...
          children: [
            ...
            Text('Tap + to add items', style: TextStyle(color: Colors.grey[500])),
          ],
        ),
      );
    }
      ...
      children: [
        ...
        Expanded(
          child: filteredItems.isEmpty
              ? Center(
                  child: Text('No items match "$searchQuery"',
          ...
          children: [
            ...
            if (item.isExpired)
              Container(
                ...
                child: const Text('EXPIRED', style: TextStyle(fontSize: 9, color: Colors.red, fontWeight: FontWeight.w700)),
              )
              ...
              Container(
                ...
                child: const Text('EXPIRING', style: TextStyle(fontSize: 9, color: Colors.orange, fontWeight: FontWeight.w700)),
              ),
          ],
        ),
        subtitle: Row(
          children: [
            if (item.barcode.isNotEmpty) ...[
              ...
              Text(item.barcode, style: const TextStyle(fontSize: 11)),
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                ...item.customFields.entries.map((e) => _detailRow(e.key, e.value)),
